      ...
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" id="surname" name="surname" value="{{ old('name') ? old('name') : $item->name }}" type="text" aria-describedby="nameHelp" placeholder="Enter last name">
      ...
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <select class="form-control" id="city" name="city" value="{{ old('city') ? old('city') : $item->city }}">
